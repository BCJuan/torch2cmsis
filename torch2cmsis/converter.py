...
class CMSISConverter:
    ...
    def save_params_conv(self, module):
        ...
        self.params[self.param_prefix_name + "_IM_DIM"] = module.input_shape[
            -1
        ]
        self.params[self.param_prefix_name + "_OUT_DIM"] = module.output_shape[
            -1
        ]
    ...
    def save_params_pool(self, module):
        self.params[self.param_prefix_name + "_OUT_CH"] = module.output_shape[
            0
        ]
